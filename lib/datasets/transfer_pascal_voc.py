...
class transfer_pascal_voc(imdb):
    def __init__(self, image_set, is_source=True, devkit_path=None):
        ...
        # Really gross hack for KITTI and driving50k being different types
        self._image_ext = '.jpg' if is_source else '.png'
    ...
    def _load_pascal_annotation(self, index):
        ...
        for ix, obj in enumerate(objs):
            ...
            x1 = float(max(float(bbox.find('xmin').text) - 1, 0))
